...
class BPMNParallelModelGeneratorArgs : CliktCommand(help = "This is a command-line tool for generating BPMN models with parallel branches up to the defined number and the defined length.") {
